...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='forword tcp port to http or socks5 proxy')
    ...
    parser.add_argument('-P', dest='proxy_host', default="127.0.0.1:8088", help='proxy host (default: 127.0.0.1:8088)')
    parser.add_argument('-f', dest='forward_host', default="127.0.0.1:80", help='remote forward host (default: 127.0.0.1:80)')
